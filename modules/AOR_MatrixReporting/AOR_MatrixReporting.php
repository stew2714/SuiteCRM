...
class AOR_MatrixReporting extends Basic
{
    public $new_schema = true;
    public $module_dir = 'AOR_MatrixReporting';
    public $object_name = 'AOR_MatrixReporting';
    public $table_name = 'aor_matrixreporting';
