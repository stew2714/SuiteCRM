...
class C1_Cust_Contacts1 extends Person
{
    public $new_schema = true;
    public $module_dir = 'C1_Cust_Contacts1';
    public $object_name = 'C1_Cust_Contacts1';
    public $table_name = 'c1_cust_contacts1';
    ...
    public $technical;
    public $sales;
    public $release_notification;
    public $marketing;
    public $accounting_invoices;
    public $survey;
    public $reference_program;
    public $business_ceo;
    public $contact_association;
    public $lead_source;
    public $reference_start_date;
    public $reference_end_date;
    public $reference_association;
    public $referenced_emr;
