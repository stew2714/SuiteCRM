...
*/
if(ACLController::checkAccess('Accounts', 'create', true))$module_menu[]=Array("index.php?module=Accounts&action=EditView&return_module=Accounts&return_action=index", $mod_strings['LNK_NEW_ACCOUNT'],"Create", 'Accounts');
