...
<script type="text/javascript">
    if (typeof SuiteFeed == 'undefined') { // since the dashlet can be included multiple times a page, don't redefine these functions
        SuiteFeed = function () {
            return {
                /**
                ...
                buildReplyForm: function (record, id, elem) {
                    ...
                    var formElem = document.getElementById('SuiteFeedReplyForm_' + id);
    ...
    if (SUGAR.util.isTouchScreen()) {
        document.addEventListener('DOMContentLoaded', function () {
            SuiteFeed.loaded('{/literal}{$idjs}{literal}')
        }, false);
    }
</script>
{/literal}
