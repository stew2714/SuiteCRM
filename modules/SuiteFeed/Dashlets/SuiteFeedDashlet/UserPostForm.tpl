    ...
    <div class="dashletNonTable" style='white-space:nowrap;'>
        <table border=0 cellspacing=0 cellpadding=2>
            <tr>
                ...
                <td><input type="checkbox" name="public" id="public" value="true">Public</td>
                <td nowrap="nowrap">
            ...
            <table>
                <tr>
                    ...
                    <td><input type='text' name='link_url'
                               title="{sugar_translate label='LBL_URL_LINK_TITLE' module='SuiteFeed'}" size='30'/></td>
...
<form name='SuiteFeedReplyForm_{$id}' id='SuiteFeedReplyForm_{$id}'>
    ...
    <div style='white-space:nowrap; display: none;'>
        <table border=0 cellspacing=0 cellpadding=2>
            <tr>
                ...
                <td nowrap="nowrap">
                    <input type="submit" value="{$LBL_POST}" class="button" style="vertical-align:top"
                           onclick="SuiteFeed.replyToFeed('{$id}'); return false;"></td>
            </tr>
        </table>
    </div>
</form>
