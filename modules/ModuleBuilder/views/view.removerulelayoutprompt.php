...
class ViewRemoveRuleLayoutPrompt extends SugarView{
	function ViewRemoveRuleLayoutPrompt(){
		parent::SugarView();
	...
	function display(){
		...
		$ajax->addSection('center', $mod_strings['LBL_ADD_LAYOUT'],$smarty->fetch('modules/ModuleBuilder/tpls/removerulelayoutprompt.tpl'));
