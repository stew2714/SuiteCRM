...
class ViewRemoveLayoutRuleDone extends SugarView{
	function ViewRemoveLayoutRuleDone(){
		parent::SugarView();
	...
	function display(){
		...
		$html=$smarty->fetch('modules/ModuleBuilder/tpls/removelayoutruledone.tpl');
