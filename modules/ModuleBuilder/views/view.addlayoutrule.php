...
class ViewAddLayoutRule extends SugarView{
    function ViewAddLayoutRule(){
        parent::SugarView();
    ...
    function display(){
        ...
        $ajax->addSection('center', $mod_strings['LBL_ADD_LAYOUT'],$smarty->fetch('modules/ModuleBuilder/tpls/addlayoutrule.tpl'));
