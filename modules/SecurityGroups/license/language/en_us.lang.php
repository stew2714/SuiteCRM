...
$license_strings = array (
    ...
    'LBL_STEPS_TO_LOCATE_KEY' => '1. Login to <a href="@@@@STORE_URL@@@@" target="_blank">@@@@STORE_LABEL@@@@</a><br/>2. Go to Account->Purchases</br>3. Locate the key for the purchase of this add-on<br/>4. Paste into the License Key box below<br/>5. Hit "Validate"',
