...
'LBL_STEPS_TO_LOCATE_KEY' => '1. Введите логин и пароль, чтобы <a href="@@@@STORE_URL@@@@" target="_blank">@@@@STORE_LABEL@@@@</a><br/>2. к Account->Purchases</br>3. Найдите ключ на покупку этого дополнения<br/>4. Вставить в окне License Key ниже<br/>5. Нажмите на "Validate"',
