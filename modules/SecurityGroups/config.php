...
$securitysuite_show_group_events = '';
if(isset($sugar_config['securitysuite_show_group_events']) && $sugar_config['securitysuite_show_group_events'] == true) {
    $securitysuite_show_group_events = 'CHECKED';
} 
$xtpl->assign('securitysuite_show_group_events', $securitysuite_show_group_events);
