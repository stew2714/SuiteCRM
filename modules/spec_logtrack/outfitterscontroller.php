...
require_once('modules/'.$currentModule.'/license/LogTrackOutfittersLicense.php');

if($_REQUEST['method'] == 'validate') {
    LogTrackOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    LogTrackOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    LogTrackOutfittersLicense::add();
    ...
    $validate_license = LogTrackOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = LogTrackOutfittersLicense::doValidate($currentModule);
