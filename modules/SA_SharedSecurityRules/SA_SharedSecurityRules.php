...
class SA_SharedSecurityRules extends Basic
{
    public $new_schema = true;
    public $module_dir = 'SA_SharedSecurityRules';
    public $object_name = 'SA_SharedSecurityRules';
    public $table_name = 'sa_sharedsecurityrules';
    ...
    function save($check_notify = FALSE){
        ...
        $condition = new SA_SharedSecurityRulesFields();
        ...
        $action = new SA_SharedSecurityRulesActions();
