 ...
 * PLACE ANY CUSTOMIZATIONS IN STEWS_External_Data
 */

require_once('include/SugarObjects/templates/person/Person.php');

class STEWS_External_Data_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'STEWS_External_Data';
	var $object_name = 'STEWS_External_Data';
	var $table_name = 'stews_external_data';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function STEWS_External_Data_sugar(){	
		parent::Person();
	}
