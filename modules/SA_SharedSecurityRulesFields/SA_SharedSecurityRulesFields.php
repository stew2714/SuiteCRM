...
class SA_SharedSecurityRulesFields extends Basic
{
    public $new_schema = true;
    public $module_dir = 'SA_SharedSecurityRulesFields';
    public $object_name = 'SA_SharedSecurityRulesFields';
    public $table_name = 'sa_sharedsecurityrulesfields';
