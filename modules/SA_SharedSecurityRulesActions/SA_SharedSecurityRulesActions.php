...
class SA_SharedSecurityRulesActions extends Basic
{
    public $new_schema = true;
    public $module_dir = 'SA_SharedSecurityRulesActions';
    public $object_name = 'SA_SharedSecurityRulesActions';
    public $table_name = 'sa_sharedsecurityrulesactions';
