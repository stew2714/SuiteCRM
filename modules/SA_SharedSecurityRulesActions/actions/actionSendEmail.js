...
function add_emailLine(ln){
  ...
  a.innerHTML += "<select tabindex='116' name='aow_actions_param["+ln+"][accesslevel]["+emailln[ln]+"]' id='aow_actions_param"+ln+"_accesslevel_target_type"+emailln[ln]+"'>" + sharedGroupRules + "</select> ";
