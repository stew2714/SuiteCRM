...
* @author IT Sapiens
*/
require_once 'modules/AdvancedReports/utils/ITSapiensDateTimeUtils.php';
...
*/
	public static function replaceTableColumnName($response, $currentUser, $tableName, $tableAlias, $columnName){
		...
		if(!self::$configuration)self::$configuration = require 'modules/AdvancedReports/config/hooks/reportModuleColumnName.php';
		
		if(isset(self::$configuration[$tableName][$columnName])){
			//reload configuration to update values in code snippets
			self::$configuration = require 'modules/AdvancedReports/config/hooks/reportModuleColumnName.php';
