        ...
        try{
            ...
            var canvgConvert  = function(){
                ...
                try{
                    ...
                    jQuery.post("modules/AnalyticReporting/bouncer.php",{image:canvas.toDataURL('image/png')},function(data){
                        window.location = "modules/AnalyticReporting/bouncer.php?img="+data;
