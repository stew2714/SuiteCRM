  ...
  */
  ...
  nv.tooltip.calcTooltipPosition = function(pos, gravity, dist, container) {
    ...
    nv.tooltip.cleanup = function() {
              ...
              var tooltips = jQuery("div.nvtooltip"); // @FIX - Prototype error
              var purging = [];
              while(tooltips.length) {
                ...
                tooltips = jQuery("div.nvtooltip"); // @FIX - Prototype error
              }
...
nv.models.multiBarChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      if (showControls) {
        var controlsData = [
          { key: translated_labels.label_grouped, disabled: multibar.stacked() },
          { key: translated_labels.label_stacked, disabled: !multibar.stacked() }
        ];

        controls.width(controlWidth()).color(['#444', '#444', '#444']);
        g.select('.nv-controlsWrap')
            .datum(controlsData)
            .attr('transform', 'translate(-30,' + (30-margin.top) +')') // #3842 - Added translate -30 instead of 0
            .call(controls);
      }
...
nv.models.multiChart = function() {
  ...
  var x = d3.scale.linear(),
      ...
      bars1 = nv.models.multiBar().stacked(bars1stacked).yScale(yScale1).hideable(false),
      bars2 = nv.models.multiBar().stacked(bars2stacked).yScale(yScale2).hideable(false),
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      // gEnter.append('g').attr('class', 'lines1Wrap');//#3858 - moved line above bar
      ...
      if (showLegend) {
        ...
        //g.select('.legendWrap')
        g.select('.nv-legendWrap')
            .attr('transform', 'translate(' + ( availableWidth / 2 ) + ',' + (20-margin.top) +')');
      }
        ...
        if (showLabels) {
          ...
          pieLabels.select(".nv-label text")
                ...
                .text(function(d, i) {
                  ...
                  var percentAddition = '';
                  if(showPercents) {
                    percentAddition = ' ('+d3.format('%')(percent)+')';
                  }
                  // #4545 [end]

                  return (d.value && percent > labelThreshold) ? labelTypes[labelType] + percentAddition : ''; // #4545
                });
        }
...
nv.models.pieChart = function() {
  ...
  d3.rebind(chart, pie, 'valueFormat', 'values', 'x', 'y', 'description', 'id', 'showLabels', 'donutLabelsOutside', 'pieLabelsOutside', 'labelType', 'showPercents', 'donut', 'donutRatio', 'labelThreshold');
  chart.options = nv.utils.optionsFunc.bind(chart);
