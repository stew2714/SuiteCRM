<?php
$mod_strings = array (
    'AnalyticReporting' => 'Rapports avancés',
    'LBL_MODULE_NAME' => 'Rapports avancés',
    'LBL_MODULE_TITLE' => 'Rapports avancés',
    'label_advanced_reports' => 'Rapports avancés',
    'label_back_to_reports' => 'Retour aux rapports',
    'label_report_editor' => 'Editeur de rapport',
    'label_filters' => 'Filtres',
    'label_report' => 'Rapport',
    'label_fields' => 'Champs',
    'label_aggregates' => 'Fonctions',
    'label_grouping_sorting' => 'Grouper &amp; Trier',
    'label_save_as' => 'Enregistrer sous',
    'label_save' => 'Enregistrer',
    'label_preview' => 'Prévisualisation',
    'label_add_filter' => 'Ajouter filtre',
    'label_add_group' => 'Ajouter groupe de filtres',
    'label_include_details' => 'Inclure les détails',
    'label_add_item' => 'Ajouter une ligne',
    'label_remove_item' => 'Supprimer une ligne',
    'label_is' => 'Est égal à',
    'label_isnt' => 'N\'est pas égal à',
    'label_is_empty' => 'Est vide',
    'label_isnt_empty' => 'N\'est pas vide',
    'label_is_before' => 'Est avant',
    'label_is_after' => 'Est après',
    'label_between' => 'Entre',
    'label_not_between' => 'N\'est pas entre',
    'label_today' => 'Aujourd\'hui',
    'label_tomorrow' => 'Demain',
    'label_tomorrow_onwards' => 'A partir de demain',
    'label_yesterday' => 'Hier',
    'label_until_yesterday' => 'Jusqu\'à hier',
    'label_day' => 'Journée',
    'label_week' => 'Semaine',
    ...
    'label_year' => 'Année',
    'label_type_to_search' => 'Type à chercher',
    'label_field' => 'Champ',
    'label_min' => 'Min',
    'label_max' => 'Max',
    'label_sum' => 'Somme',
    ...
    'label_count' => 'Compter',
    'label_is_crosstab' => 'Tableau croisé dynamique',
    'label_aggregates_as_column' => 'Champs calculés en colonnes',
    'label_action' => 'Action',
    ...
    'label_export_xlsx' => 'Exporter en .xlsx',
    ...
    'label_export_send_url' => 'Envoyer un lien vers ce rapport',
    'label_export_format' => 'Envoyer le rapport au format',
    'label_chart_editor' => 'Editeur de graphes',
    'label_chart_type' => 'Type de graphe',
    'label_legend_axis' => 'Légende & Axes',
    'label_title' => 'Titre',
    'label_type' => 'Type',
    'label_chart' => 'Graphe',
    'label_contains' => 'Contient',
    'label_doesnt_contain' => 'Ne contient pas',
    'label_starts_with' => 'Commence par',
    'label_ends_with' => 'Fini par',
    'label_description' => 'Description',
    'label_no' => 'No.',
    'label_report_name' => 'Nom du rapport',
    'label_tools' => 'Outils',
    'label_up' => 'Monter',
    'label_down' => 'Descendre',
    'label_primary_horizontal' => 'Abscisse',
    'label_secondary_vertical' => 'Ordonnées',
    'label_drag_values_hint' => 'Glissez déposez les items suivants pour définir leur ordre dans l\'entonnoir', // #4540
    'label_funnel_group_by' => 'Entonnoir grouper par', // #4540
    'label_cumulated' => 'Cumulé', // #4540
    'label_legend' => 'Légende',
    'label_value' => 'Valeur',
    'label_and' => 'et',
    'label_or' => 'ou',
    'label_row' => 'Ligne',
    'label_clumn' => 'Colonne',
    'label_save_report_as' => 'Enregistrer le rapport sous',
    'label_sort' => 'Trier',
    'label_group' => 'Grouper',
    'label_group_sort' => 'Grouper & Trier',
    'label_descending' => 'Descendant',
    'label_ascending' => 'Ascendant',
    'label_saved' => 'Sauvegardé avec succès',
    'label_new_report_saved' => 'Nouveau rapport sauvegardé',
    'label_sort_by_aggregates' => 'Trier par',
    'label_column' => 'Colonne',
    'label_cancel' => 'Annuler',
    'label_access' => 'Partage &amp; Planification',
    'label_user' => 'Utilisateur',
    'label_owner' => 'Propriétaire',
    'label_private' => 'Privé',
    'label_public' => 'Public',
    'label_can_edit' => 'Peut Modifier',
    'label_can_view' => 'Lecture seule',
    'label_pie_chart' => 'Camembert',
    'label_line_chart' => 'Courbes',
    'label_area_chart' => 'Area',
    'label_column_chart' => 'Colonne',
    'label_combined_chart' => 'Combiné',
    'label_funnel_chart' => 'Entonnoir', // #4540
    'label_date_group' => 'Grouper date',
    'Advanced Reports' => 'Rapports avancés',
    'label_can_delete' => 'Peut modifier et supprimer',
    'label_report_folders' => 'Dossiers',
    'label_add_folder' => 'Ajouter dossier',
    ...
    'label_edit' => 'Editer',
    'label_new_report_folder' => 'Nouveau dossier',
    'label_select_one' => 'Merci de sélectionner au moins un champ de calcul',
    'label_if_only_sort' => 'L\'option \'Group by\' n\'est pas disponible si \'Sort by\' est uniquement sélectionné au niveau précédent',
    'label_delete_children' => 'Merci de supprimer tous les rapports de ce dossier au prélable.',
    'label_level' => 'Niveau',
    'label_third_vertical' => '2ème axe des ordonnées',
    'label_edit_report_folder' => 'Modifier le dossier',
    'label_everyone' => 'Tout le monde',
    'label_save_chart' => 'Enregistrer le graphe comme une image',
    'label_tooltip_msg_1' => 'Sélectionnez cette option pour voir en détail tous les champs sélectionnés en dessous de chaque champ groupé ou calculé.<br/>Si cette option n\'est pas sélectionnée, vous verrez uniquement les données calculées ou groupées dans votre rapport, vous ne verrez pas les champs qui ne font pas partie des fonctions de Calcul ou de Regroupement & Tri.',
    'label_tooltip_msg_2' => 'Sélectionnez cette option pour faire apparaître les champs calculés en bout de ligne (comme une nouvelle colonne) et non plus en pied de tableau. Pour activer cette option, sélectionnez le statut ou la position de date en \"Colonne\" (et non \"Ligne\"  disponible dans l\'onglet \"Grouper &amp; Trier\". Pour les autres groupes, laissez la position sur la valeur: \"Ligne\".',
    'label_selected_columns' => 'Sélectionnez les colonnes de votre rapport',
    'label_dont_group' => 'Ne pas grouper',
    'label_sure_to_delete' => 'Etes-vous sûr de vouloir supprimer ce rapport?',
    'label_remove_filter' => 'Supprimer filtre',
    'label_chart_error' => 'Pour un graphe combiné, sélectionnez au moins 2 champs calculés dans les paramètres de votre rapport: dans l\'onglet \'Fonctions\' et \'Grouper & Trier\'',
    'label_at_least_column' => 'Pour un tableau croisé dynamique, vous devez sélectioner la position en \"Colonne\" pour au moins un champ dans l\'onglet \"Grouper & Trier\", (actuellement tous les champs sont positionnés en  \"Ligne\"). Sinon, décochez uniquement l\'option \"Tableau croisé dynamique\".',
    'label_select_summaries' => 'Sélectionnez les champs de synthèse à afficher dans ce rapport',
    'label_add_to_dashboard' => 'Ajouter à la page d\'accueil', // #4023
    'label_chart_added_to_dashboard' => 'Graphe ajouté à la page d\'accueil', // #4023
    'label_sharing' => 'Partage', // #4044
    'label_scheduling' => 'Planification', // #4044
    'label_role' => 'Rôle', // #4044
    'label_frequency' => 'Fréquence', // #4044
    'label_daily' => 'Quotidienne', // #4044
    'label_weekly' => 'Hebdomadaire', // #4044
    'label_biweekly' => 'Bi-hebdomadaire', // #4044
    'label_monthly' => 'Mensuelle', // #4044
    'label_yearly' => 'Annuelle', // #4044
    'label_schedule_report' => 'Planification', // #4044
    'label_time' => 'Heure', // #4044
    'label_monday' => 'Lundi', // #4044
    'label_tuesday' => 'Mardi', // #4044
    'label_wednesday' => 'Mercredi', // #4044
    'label_thursday' => 'Jeudi', // #4044
    'label_friday' => 'Vendredi', // #4044
    'label_saturday' => 'Samedi', // #4044
    'label_sunday' => 'Dimanche', // #4044
    'label_week_of_month' => 'Semaine du mois', // #4044
    'label_week_first_third' => '1ère et 3ème', // #4044
    'label_week_second_fourth' => '2ème et 4ème', // #4044
    'label_stacked' => 'Empilé',
    'label_chart_size' => 'Taille du graphe', // #4038
    'label_chart_not_possible' => 'Pour créer un rapport, merci de sélectionner au moins 1 champ calculé et 1 champ groupé/trié, puis sauvegardez votre rapport',
    //#4087 [start]
    'label_next_days' => 'Prochains jours',
    'label_passed_days' => 'Jours d\'avant',
    'label_greater_than_days' => 'Après un nombre de jours',
    'label_less_than_days' => 'Avant un nombre de jours',
    //#4087 [end]
    'LBL_DURATION_H' => 'Durée (heures)',
    'LBL_DURATION_DAY' => 'Durée (jours)',
    'label_to_create_report' => 'Créer un nouveau rapport...',
    'label_to_create_new' => 'Pour créer un nouveau rapport , merci de sélectionner et d\'ouvrir l\'un des rapports existants de la liste (dans le module correspondant) puis cliquez sur le bouton \"Enregistrer sous\" dans le rapport concerné: vous pourrez indiquer le nom et le dossier du nouveau rapport, puis modifier le nouveau rapport selon vos besoins.',
    // #4351 [start] - Added translations
    'label_chart_height' => 'Hauteur du graphe',
    'label_chart_height_increase' => 'Augmenter',
    'label_chart_height_decrease' => 'Diminuer',
    // #4351 [end]
    'LBL_LEAD_CONVERTED' => "Convertit", //#4432
    'label_print_report' => "Imprimer rapport",
    'label_print_reportChart' => "Imprimer rapport & graphes",
    'label_merge_multiple_selections' => "Séparer chaque valeur",
    //#4439 [start] - new date filters
    'label_this_week' => 'Cette semaine',
    'label_last_week' => 'Semaine dernière',
    'label_this_month' => 'Ce mois-ci',
    'label_last_month' => 'Le mois dernier',
    'label_this_year' => 'Cette année',
    'label_last_year' => 'L\'année dernière',
    //#4439 [end]
    'label_freeze_first' => 'Freeze first', // #4453
    'label_columns' => 'columns', // #4453
    'label_show_percents' => 'Montrer pourcentage (%)', // #4545
    ...
    'reportBuilderPublicAccess' => 'Allow public access',
