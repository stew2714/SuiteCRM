 ...
 * PLACE ANY CUSTOMIZATIONS IN cust_cust_CustomerInfo
 */

require_once('include/SugarObjects/templates/person/Person.php');

class cust_cust_CustomerInfo_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'cust_cust_CustomerInfo';
	var $object_name = 'cust_cust_CustomerInfo';
	var $table_name = 'cust_cust_customerinfo';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function cust_cust_CustomerInfo_sugar(){	
		parent::Person();
	}
