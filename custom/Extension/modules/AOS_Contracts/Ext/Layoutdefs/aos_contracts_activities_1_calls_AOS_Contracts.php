...
$layout_defs["AOS_Contracts"]["subpanel_setup"]['activities'] = array (
  ...
  array (
    ...
    array (
      ...
      'get_subpanel_data' => 'aos_contracts_activities_1_meetings',
    ),
    'tasks' => 
    array (
      'module' => 'Tasks',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'aos_contracts_activities_1_tasks',
    ),
    'calls' => 
    array (
      'module' => 'Calls',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'aos_contracts_activities_1_calls',
    ),
  ),
...
$layout_defs["AOS_Contracts"]["subpanel_setup"]['history'] = array (
  ...
  array (
    ...
    array (
      'module' => 'Notes',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'aos_contracts_activities_1_notes',
    ),
    'emails' => 
    array (
      'module' => 'Emails',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'aos_contracts_activities_1_emails',
    ),
  ),
