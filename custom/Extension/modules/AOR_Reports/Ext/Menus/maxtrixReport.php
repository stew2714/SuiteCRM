...
if(ACLController::checkAccess('AOR_MatrixReporting', 'list', true)){
    $module_menu[]=array('index.php?module=AOR_MatrixReporting&action=index&return_module=AOR_MatrixReporting&return_action=DetailView', $mod_strings['LNK__MATRIX_LIST'],'View', 'AOR_MatrixReporting');
}
