                                ...
                                {{if isset($colData.field.popupHelp) || isset($fields[$colData.field.name]) && isset($fields[$colData.field.name].popupHelp) }}
                                    {{if isset($colData.field.popupHelp)}}
                                        {{capture name="popupText" assign="popupText"}}
                                            {sugar_translate label="{$colData.field.popupHelp}" module='{{$fields[$colData.field.name].moduleCore}}'}
                                        {{/capture}}
                                    {{elseif isset($fields[$colData.field.name].popupHelp)}}
                                        {capture name="popupText" assign="popupText"}
                                            {sugar_translate label="{{$fields[$colData.field.name].popupHelp}}" module='{{$fields[$colData.field.name].moduleCore}}'}
                                        {/capture}
                                    {{/if}}
                            ...
                            {{if !empty($def.templateMeta.labelsOnTop)}}
                                {{if isset($colData.field.label)}}
                                    {{if !empty($colData.field.label)}}
                                        <label for="{{$fields[$colData.field.name].name}}">{sugar_translate label='{{$colData.field.label}}' module='{{$fields[$colData.field.name].moduleCore}}'}:</label>
                                    {{/if}}
                                {{elseif isset($fields[$colData.field.name])}}
                                    <label for="{{$fields[$colData.field.name].name}}">{sugar_translate label='{{$fields[$colData.field.name].vname}}' module='{{$fields[$colData.field.name].moduleCore}}'}:</label>
                                {{/if}}
