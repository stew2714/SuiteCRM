...
require_once('custom/include/SearchForm/CustomSearchForm2.php');
define("NUM_COLS", 2);
class CustomPopupSmarty extends ListViewSmarty{
	...
	public function __construct($seed, $module){
		...
		$this->view = 'Popup';
		$this->module = $module;
		$this->searchForm = new CustomSearchForm($this->seed, $this->module);
