...
class CustomCallFormBase extends FormBase {
...
function handleSave($prefix,$redirect=true,$useRequired=false) {
	...
	if (isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == 'Home'){
        ...
        // If we pressed Close and Create New
        if ($this->isCloseAndCreateNewRequest()) {
            SugarApplication::redirect("index.php?module=Calls&record=&action=EditView");
        }
    ...
    protected function isCloseAndCreateNewRequest()
    {
