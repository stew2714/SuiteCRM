...
function insertFieldLine(){
    ...
    if(action_sugar_grp1 == 'EditView'){
        a.innerHTML = "<button type='button' id='aor_fields_delete_line" + fieldln + "' class='button' value='' tabindex='116' onclick='markFieldLineDeleted(" + fieldln + ");  UpdatePreview(\"preview\");'><img src='themes/default/images/id-ff-remove-nobg.png' alt=''></button><br>";
    ...
    c.innerHTML += "<input id='aor_fields_display" + fieldln + "' name='aor_fields_display["+ fieldln +"]' value='1'  onclick='UpdatePreview(\"preview\");' type='checkbox' CHECKED>";
    c.style.width = '5%';

    var d = x.insertCell(4);
    d.innerHTML = "<input name='aor_fields_link["+ fieldln +"]' value='0' type='hidden'>";
    d.innerHTML += "<input id='aor_fields_link" + fieldln + "' name='aor_fields_link["+ fieldln +"]' value='1' type='checkbox' onclick='UpdatePreview(\"preview\");'>";
    d.style.width = '5%';

    var e = x.insertCell(5);
    e.innerHTML = "<input name='aor_fields_label["+ fieldln +"]' id='aor_fields_label" + fieldln + "' size='20' maxlength='150'  onblur='UpdatePreview(\"preview\");' value='' type='text'>";
    e.style.width = '12%';
    ...
    var g=x.insertCell(7);
    g.innerHTML = "<select type='text' onchange='UpdatePreview(\"preview\");' name='aor_fields_sort_by["+ fieldln +"]' id='aor_fields_sort_by" + fieldln + "'>"+sort_by_values+"</select>";
    g.style.width = '10%';
    ...
    var i=x.insertCell(9);
    i.innerHTML = "<select type='text' onchange='UpdatePreview(\"preview\");' name='aor_fields_format["+ fieldln +"]' id='aor_fields_format" + fieldln + "' style='display:none;'>" + format_values + "</select>";
    i.style.width = '10%';

    var h=x.insertCell(10);
    h.innerHTML = "<select type='text' onchange='UpdatePreview(\"preview\");' name='aor_fields_total["+ fieldln +"]' id='aor_fields_total" + fieldln + "'>"+total_values+"</select>";
    h.style.width = '10%';
