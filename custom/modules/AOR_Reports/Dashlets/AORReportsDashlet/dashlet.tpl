{if !$onlyCharts}
    {literal}
        <script>
                function changeReportPage(record, offset, group_value, table_id, view_as){
            ...
            $(document).ready(function(){
                if('{/literal}{$report_id}{literal}'){
                    ...
                    changeReportPage('{/literal}{$report_id}{literal}', 0, '','{/literal}{$dashlet_id}{literal}', '{/literal}{$viewing_as}{literal}');
                }
            });
...
<script src="custom/modules/AOR_Reports/Dashlets/AORReportsDashlet/AORReportsDashlet.js"></script>