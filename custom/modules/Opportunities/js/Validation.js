...
$( document ).ready(function() {
  ...
  function checkRules(){
    ...
    if ((document.getElementById("product_c").value == "FFCC" || document.getElementById("product_c").value == "FFCT" || document.getElementById("product_c").value == "COS") && document.getElementById("recordtypeid").value == "Partner" && document.getElementById("encoder_c").value == ""){
    ...
    if (document.getElementById("product_c").value == "COS" && document.getElementById("probability").value > 0.5 && document.getElementById("fte_c").value == ""){
    ...
    if (document.getElementById("term_length_mm_c").value == null && document.getElementById("co_status_c").value == "Complete"
      && (document.getElementById("product_c").value == "TOS" || document.getElementById("product_c").value =="Sub")){
    ...
    if (document.getElementById("product_c").value == "FD" && document.getElementById("number_of_licenses_c").value < 1){
      addToValidate('EditView',"number_of_licenses_c",'varchar',true,SUGAR.language.get('Opportunities', 'LBL_NUMBER_OF_LICENSES_REQUIRED'));
    }else{
    ...
    if (document.getElementById("recordtypeid").value != "CBay" && document.getElementById("sales_stage").value == "Closed Won"
      ...
      addToValidate('EditView',"global_use_probability_percent_c",'varchar',true,SUGAR.language.get('Opportunities', 'LBL_REQUIRE_ILP_PROBABILITY_TO_BE_0_OR_100'));
    }else{
      if( checkValidate("EditView", "global_use_probability_percent_c")){
        removeFromValidate("EditView","global_use_probability_percent_c" );
      }
    }
